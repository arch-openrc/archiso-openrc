...
make_efi() {
    ...
    cp ${script_path}/efiboot/gummibootx64.efi ${work_dir}/iso/EFI/boot/loader.efi
...
make_efiboot() {
    ...
    cp ${script_path}/efiboot/gummibootx64.efi ${work_dir}/efiboot/EFI/boot/loader.efi
